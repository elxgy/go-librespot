...
func (o *recordingOutput) Closed() bool            { return false }
...
// p.done, p.crossfadeSamples and p.newOutput.
...
// buffer, clipping the first samples of the incoming track; the pulse restart
// inside Drop also wedged manageLoop on a stalled pulse server.
